                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-9">
                                <div class="d-flex align-items-center align-self-start">
                                    <h3 class="mb-0">{{$total_users -1}}</h3>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-9">
                                <div class="d-flex align-items-center align-self-start">
                                    <h3 class="mb-0">EGP {{$orders_revenue}}</h3>
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="icon icon-box-success ">
                        ...
                        <h6 class="text-muted font-weight-normal">Orders Revenue <span style="font-size: 10px">(ordered but not paid)</span></h6>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <script type="text/javascript">
                            ...
                            function drawChart() {
                                var data = google.visualization.arrayToDataTable([
                                    ['Status', 'Count'],
                                    ['Processing', {{$order_proccessing}}],
                                    ['Delivered', {{$order_delivered}}],
                                    ['Cancelled', {{$order_canceled}}],
                                ]);

                                var options = {'legend': 'none','width':400,'is3D':true ,'height':300 ,'backgroundColor': 'none' ,'colors': ['#002980', '#007317','#ff0000' ]};
                        ...
                        <div class="bg-gray-dark d-flex d-md-block d-xl-flex flex-row py-3 px-4 px-md-3 px-xl-4 rounded mt-3">
                            ...
                            <div class="align-self-center flex-grow text-right text-md-center text-xl-right py-md-2 py-xl-0">
                                <h6 class="font-weight-bold mb-0">{{$order_delivered}}</h6>
                            </div>
                        </div>
                        <div class="bg-gray-dark d-flex d-md-block d-xl-flex flex-row py-3 px-4 px-md-3 px-xl-4 rounded mt-3">
                            <div class="text-md-center text-xl-left">
                                <h6 class="mb-1">Not Delivered</h6>
                                <p class="text-muted mb-0">07 Jan 2019, 09:12AM</p>
                            </div>
                            <div class="align-self-center flex-grow text-right text-md-center text-xl-right py-md-2 py-xl-0">
                                <h6 class="font-weight-bold mb-0">{{$order_proccessing}}</h6>
                            </div>
                        </div>
                        <div class="bg-gray-dark d-flex d-md-block d-xl-flex flex-row py-3 px-4 px-md-3 px-xl-4 rounded mt-3">
                            <div class="text-md-center text-xl-left">
                            ...
                            <div class="align-self-center flex-grow text-right text-md-center text-xl-right py-md-2 py-xl-0">
                                <h6 class="font-weight-bold mb-0">{{$order_canceled}}</h6>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-8 col-sm-12 col-xl-8 my-auto">
                                <div class="d-flex d-sm-block d-md-flex align-items-center">
                                    <h2 class="mb-0">EGP {{$actual_revenue}}</h2>
                                    <p class="text-success ml-2 mb-0 font-weight-medium">+3.5%</p>
                                </div>
                                <h6 class="text-muted font-weight-normal">already paid</h6>
                            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-8 col-sm-12 col-xl-8 my-auto">
                                <div class="d-flex d-sm-block d-md-flex align-items-center">
                                    <h2 class="mb-0">{{$order_proccessing}}</h2>
                                </div>
                                <h6 class="text-muted font-weight-normal">Under Processing</h6>
                            </div>
                            <div class="col-4 col-sm-12 col-xl-4 text-center text-xl-right">
